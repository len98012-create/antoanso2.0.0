...
import { X, BrainCircuit, CheckCircle2, Circle } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-slate-800 w-full max-w-md rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden transform transition-all scale-100">
        ...
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50">
          <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
            ...
            <h2 className="font-bold text-lg">Tạo thử thách an toàn</h2>
          </div>
          {!isLoading && (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                placeholder="Ví dụ: Mật khẩu, Lừa đảo, Mạng xã hội..."
                disabled={isLoading}
